...
with open("log_coinfo.txt", "w", encoding="utf-8") as f:
    f.write("Starting coinfo script...\n")
    try:
        response = requests.get(url, headers=headers, verify=False, timeout=10)
        f.write(f"Response status: {response.status_code}\n")
        response.encoding = 'euc-kr'
        
        # Write response text snippet
        f.write("Response text snippet:\n")
...
print("ASCII: Done, check log_coinfo.txt")
