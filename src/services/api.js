...
function synthesizeStockAnalysis(id, name, sector, price, changeRate, reports, rawReportTexts) {
  ...
  const macroFed = "2026년 5월 현재 미 연준(Fed)의 통화 긴축 기조에서 금리 인하 사이클로의 기조 전환 모멘텀이 나타나며, 기술 성장주 할인율이 점진적으로 해소되고 있습니다.";
  const macroFx = "원/달러 환율이 1,300원대 중후반에서 높은 변동성을 유지함에 따라, 수출 의존도가 높은 본 종목의 해외 환차익 수혜 및 원화 매출 부풀리기 효과가 극대화되는 상황입니다.";
